...
class Detail extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      sf001Tracker: new Company(props.sf001Tracker),
  ...
  handleStartEditExisting = () => {
    ...
    const {sf001Tracker} = this.state
    this.setState({
      sf001TrackerCopy: new Company(sf001Tracker),
  ...
  handleCancelEditExisting = () => {
    ...
    this.reasonsInvalid.clearAll()
    this.setState({
      sf001Tracker: new Company(sf001TrackerCopy),
...
Detail.propTypes = {
   ...
   */
  sf001Tracker: PropTypes.instanceOf(Company),
